...
const FREE_FEATURES = [
  ...
  "3 profils débloqués par jour",
  "1 contact WhatsApp par mois",
  "Stats limitées",
];

const PRO_FEATURES = [
  "Jusqu'à 5 offres actives en parallèle",
  "Profils débloqués illimités",
  "Contacts WhatsApp illimités",
  "Statistiques détaillées (vues, candidatures)",
  "Badge entreprise vérifiée",
  "Apparition mise en avant dans les résultats",
];
  ...
  return (
    <div className="space-y-4">
      ...
      <header className="text-center space-y-1">
        <h1 className="text-2xl font-bold">Recrutez sans limite</h1>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <article className="jc-card p-5 bg-jc-primary-dark text-white relative overflow-hidden">
          ...
          <div className="space-y-1">
            <p className="text-xs font-bold tracking-wide text-white/70">PRO</p>
            <h2 className="text-xl font-bold inline-flex items-center gap-2">
              <Sparkles className="w-5 h-5" />
              Entreprise Pro
            </h2>
            <p className="text-2xl font-bold mt-2">
              {PLAN_AMOUNTS.employer_pro.toLocaleString("fr-FR")}
